...
test("commissioning reaches a complete review without forcing a product classification",async({page})=>{
...
test("live monitor renders attributed GDELT coverage and filters research areas",async({page})=>{
  ...
  await page.getByLabel("Research area").selectOption("defence-security");
