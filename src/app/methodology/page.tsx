...
export default function MethodologyPage() {
  return (
    <>
      <PageHero index={[{ label: "Public data", href: "#public-data" }, { label: "Human research", href: "#human-research" }, { label: "Freshness", href: "#freshness" }, { label: "Demonstration data", href: "#demonstration-data" }, { label: "Limitations", href: "#limitations" }]} title="The source is part of the answer." description="Tharros records where information came from, when it was current, how it was interpreted and what it cannot establish." />
      <section className="section methodology-grid">
        <div className="methodology-main">
          <article id="public-data"><h2>Public data</h2><p>Official datasets may provide trade values, product classifications, importer names, geographic patterns or business-register information. Each usable data block should carry publisher, dataset, URL, period, update date, retrieval date, licence and limitations.</p></article>
          <article id="human-research"><h2>Human research</h2><p>Manual work adds classification checks, company relevance, channel context and source corroboration. It does not convert public indicators into certainty; observations and inferences are labelled as such.</p></article>
          <article id="freshness"><h2>Freshness</h2><p>“Latest” means the most recent period available from the stated publisher—not today. Publication lag, revisions and changes in classification are recorded when they affect interpretation.</p></article>
          ...
          <article id="limitations"><h2>Limitations</h2><p>HS categories may be broader than a product. Import values do not measure addressable demand. Importer records may include customs brokers or non-resident importers. Company websites can be incomplete or stale. Every output should state the limits that matter to the decision.</p></article>
        </div>
