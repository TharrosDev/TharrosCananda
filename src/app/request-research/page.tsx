...
export default function RequestResearchPage(){
  ...
  return <>
    ...
    <section className="section section--compact request-layout commission-desk"><ResearchRequestForm contactEmail={contactEmail}/><aside className="request-sidebar">
      ...
      <h2>Scope</h2><p>Tharros does not provide legal, tax, regulatory, lobbying or investment advice.</p>
      <h2>Prefer email?</h2><p>Write to <a href={`mailto:${contactEmail}`}>{contactEmail}</a> with the same information.</p>
    ...
    <section className="commission-assurance"><p>Submitting does not create a purchase.</p><p>Work starts after written approval.</p></section>
  </>;
}
