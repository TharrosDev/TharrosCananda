      ...
      <section className="section policy-page">
        ...
        <article>
          ...
          <p className="policy-example">
            ...
            /research/[publication], licensed under {researchLicence.short}. Changes: [describe, or
            “none”].
          </p>
          <p>
        ...
        <article>
          ...
          <p>
            ...
            <a href={`${researchLicence.url}legalcode`}>{researchLicence.short} legal code</a> sets
            out the binding terms, including its disclaimer of warranties.
          </p>
        </article>
        <article>
