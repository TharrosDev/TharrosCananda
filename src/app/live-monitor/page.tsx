...
export const metadata: Metadata = {
  title: "Live Monitor",
  description: "Recent Canada–Europe reporting across trade, defence, energy, industry and strategic technology, powered by Currents.",
    ...
    <>
      ...
      <section className="section section--compact monitor-page">
        <div className="service-context monitor-intro">
          <p className="pricing-note">Currents powers the automated discovery layer. Headlines, descriptions and source links remain attributed to their original publishers; inclusion is not verification, endorsement or a Tharros research finding.</p>
      ...
      <section className="about-independence">
        ...
        <div>
          <p>The monitor searches a rolling seven-day Currents window for reporting that connects Canada with Europe across the same four research areas used throughout Tharros Canada. Publication time and direct publisher links stay visible with each result.</p>
